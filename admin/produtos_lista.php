<?php
    ...
    $lista = $conn->query("SELECT * FROM vw_produtos ORDER BY descricao");
        ...
        <table class="table table-hover table-condensed tb-opacidade bg-warning">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="../images/<?= $row['imagem']; ?>" class="img-fluid" width="85px">
                    </td>
                    <td>
                        <a href="produto_atualiza.php?id=<?= $row['id'] ?>" role="button" class="btn btn-warning btn-block btn-xs">
                        ...
                        ?>
                            <button data-nome="<?= $row['descricao']; ?>" data-id="<?= $row['id']; ?>" class="delete btn btn-xs btn-block btn-danger <?php echo $regraRow['destaque']=='Sim'?'hidden':'' ?>">
