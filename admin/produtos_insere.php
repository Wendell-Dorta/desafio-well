<?php
    ...
    if ($_POST) {
        ...
        $insereProduto = "INSERT INTO produtos (tipo_id,descricao,destaque,resumo,valor,imagem,destaque) VALUES ($id,'$descricao','$resumo',$valor,'$imagem','$destaque')";
