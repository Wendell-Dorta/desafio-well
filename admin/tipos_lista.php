<?php
    ...
    $lista = $conn->query("SELECT * FROM tipos ORDER BY rotulo");
        ...
        <table class="table table-hover table-condensed tb-opacidade bg-warning">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class=""><?= $row['rotulo']; ?></td>
                    <td class="col-xs-1">
                        <a href="tipos_atualiza.php?id=<?= $row['id'] ?>" role="button"
                            class="btn btn-warning btn-block btn-xs">
                            <span class="glyphicon glyphicon-refresh"></span>
                            <span class="hidden-xs">ALTERAR</span>
                        </a>
                        <button data-nome="<?= $row['rotulo']; ?>" data-id="<?= $row['id']; ?>"
...
$('.delete').on('click', function() {
    ...
    $('a.delete-yes').attr('href', 'tipos_excluir.php?id=' +
