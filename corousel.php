<div id="banners" class="carousel slide" data-ride="carousel">
    ...
    <a href="#banners" class="left carousel-control" data-target="#banners" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
        <span class="sr-only">Anterior</span>
    </a>
    <a href="#banners" class="right carousel-control" data-target="#banners" role="button" data-slide="next">
